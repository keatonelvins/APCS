...
public class Lab16c
{
	public static void main( String args[] )
	{
		...
		testWordList("one two three four five six seven alligator", test);
		testWordList("fun fly four six times ten plus eight", test);
		testWordList("alligator chicken dog cat pig buffalo", test);
		
	}


	public static void testWordList(String wordList, Words test)
	{
		test.setWords(wordList);
		out.println(test);
